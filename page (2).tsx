...
export default function SettingsPage() {
  ...
  const handleWebsiteSettingChange = (key: string, value: any) => {
    setWebsiteSettings({
      ...websiteSettings,
      [key]: value,
    })
    ...
    <div className="container mx-auto p-6">
      ...
      <Tabs defaultValue="website" className="w-full">
        <TabsList className="grid w-full grid-cols-2">
          ...
          <TabsTrigger value="server" disabled={!canManageServer}>
            Server Settings
          </TabsTrigger>
        </TabsList>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleWebsiteSettingChange("darkMode", checked)}
                  />
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleWebsiteSettingChange("notificationsEnabled", checked)}
                  />
                </div>
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleWebsiteSettingChange("emailNotifications", checked)}
                  />
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleWebsiteSettingChange("activityWarningDays", Number.parseInt(e.target.value))}
                  />
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleWebsiteSettingChange("showOfflineUsers", checked)}
                  />
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleServerSettingChange("serverName", e.target.value)}
                  />
                </div>
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleServerSettingChange("serverDescription", e.target.value)}
                  />
                </div>
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleServerSettingChange("motd", e.target.value)}
                  />
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleServerSettingChange("maxPlayers", Number.parseInt(e.target.value))}
                  />
                </div>
                <div className="grid gap-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => handleServerSettingChange("difficulty", value)}
                  >
                ...
                <div className="grid gap-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => handleServerSettingChange("gamemode", value)}
                  >
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleServerSettingChange("pvp", checked)}
                  />
                </div>
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleServerSettingChange("whitelist", checked)}
                  />
                </div>
              </div>
